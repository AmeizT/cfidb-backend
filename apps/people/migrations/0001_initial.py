# Generated by Django 4.2.3 on 2023-10-07 18:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relationship_status', models.CharField(blank=True, choices=[('Single', 'Single'), ('Married', 'Married'), ('Divorced', 'Divorced'), ('Widowed', 'Widowed'), ('Separated', 'Separated'), ('Engaged', 'Engaged'), ('In a Relationship', 'In a Relationship'), ('Domestic Partnership', 'Domestic Partnership'), ('Civil Union', 'Civil Union'), ('Committed', 'Committed'), ('Common-Law Marriage', 'Common-Law Marriage'), ('Traditional Marriage', 'Traditional Marriage'), ('Co-parenting', 'Co-parenting')], max_length=255)),
